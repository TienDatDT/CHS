...
public class Customer extends JFrame implements MouseListener {
	private JButton save,edit,del,re,look,imp,exp;
	private JLabel l,lnv,lbook,lusr,lcus,l3,l4,l5,l7;
	...
	private ArrayList<CustomerDTO> list1;
	...
	public Customer() {
		...
		l3=new JLabel("ID");
		l3.setBounds(110, 80, 50,15);
		t3=new JTextField();
		t3.setBounds(110, 100, 50, 25);
		panel.add(l3);
		panel.add(t3);
		
		l4=new JLabel("Tên Khách Hàng");
		l4.setBounds(170, 80 , 150, 15);
		panel.add(l4);
		t4=new JTextField();
		t4.setBounds(170, 100, 150, 25);
		panel.add(t4);
		
		l5=new JLabel("Địa Chỉ");
		l5.setBounds(330, 80 , 100, 15);
		panel.add(l5);
		t5=new JTextField();
		t5.setBounds(330, 100, 100, 25);
		panel.add(t5);
		...
		table.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(table.getSelectedColumnCount()==1) {
					...
					String tenkh=model.getValueAt(table.getSelectedRow(), 1).toString();
					String diachi=model.getValueAt(table.getSelectedRow(), 2).toString();
					String sdt=model.getValueAt(table.getSelectedRow(), 3).toString();
		...
		list1= CustomerDAO.khList();
		model = new DefaultTableModel();
		Object[] col={"Mã Khách Hàng","Tên Khách Hàng","Địa Chỉ","SDT"};
		Object[] row=new Object[6];
		model.setColumnIdentifiers(col);
			for(int i=0;i<list1.size();i++) {
				row[0]=list1.get(i).getIDKH();
				row[1]=list1.get(i).getTenKH();
				row[2]=list1.get(i).getDiaChi();
				row[3]=list1.get(i).getSDT();
				model.addRow(row);
			}
		...
		b2=new JRadioButton("Tên Khách Hàng");
